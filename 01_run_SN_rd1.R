...
datExprT <- fread("/mnt/lareaulab/reliscu/projects/NSF_GRFP/data/bulk/GTEx/cortex/GTEx_cortex_gene_counts.csv", data.table=FALSE)
...
projectname1 <- "GTEx_cortex_counts"
